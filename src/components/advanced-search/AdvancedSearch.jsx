                        ...
                        <Col offset={1} span={5} style={{display: "block"}}>
                            <Form.Item label="Fish" colon={false}>
                                {getFieldDecorator('fish')(
                                    <Input name="fish" placeholder="Type name" onChange={handleTextChange}/>
                                )}
                            </Form.Item>
                        </Col>
                        <Col offset={18}>
                            ...
                            <Col offset={1} span={5} style={{display: "block", marginRight: 20}}>
                                <Form.Item label="Family" colon={false}>
                                    {getFieldDecorator('family')(
                                        <Input name="family" placeholder="Type family" onChange={handleTextChange}/>
                                    )}
                                </Form.Item>
                            </Col>
                            <Col span={5} style={{display: "block", marginRight: 20}}>
                                <Form.Item label="Genus" colon={false}>
                                    {getFieldDecorator('genus')(
                                        <Input name="genus" placeholder="Type genus" onChange={handleTextChange}/>
                                    )}
                                </Form.Item>
                            </Col>
                            <Col span={5} style={{display: "block"}}>
                                <Form.Item label="Species" colon={false}>
                                    {getFieldDecorator('species')(
                                        <Input name="species" placeholder="Type species" onChange={handleTextChange}/>
                                    )}
                                </Form.Item>
                            </Col>
                        </Row>
                            ...
                            <Col offset={1} span={5} style={{display: "block", marginRight: 20}}>
                                <Form.Item label="Group" colon={false}>
                                    ...
                                    {getFieldDecorator('group', {
                                        ...
                                        >
                                            <Option id={1} value="marine">Marine</Option>
                                            <Option id={2} value="freshwater">Freshwater</Option>
                                            <Option id={3} value="pond">Pond</Option>
                                        </Select>,
                                    )}
                                </Form.Item>
                            </Col>
                            <Col span={5} style={{display: "block", marginRight: 20}}>
                                <Form.Item label="Temperature" colon={false}>
                                    {getFieldDecorator('temperatureRef', {
                                        onChange: (value) => handleSelection('temperatureRef', value)
                                    })(
                                        <Select
                                            placeholder="Select an option"
                                        >
                                            <Option id={1} value="coldWater">Cold Water</Option>
                                            <Option id={2} value="tropical">Tropical</Option>
                                        </Select>,
                                    )}
                                </Form.Item>
                            </Col>
                                ...
                                <Form.Item label="Breeding" colon={false}>
                                    {getFieldDecorator('breeding', {
                                        ...
                                        <Select
                                            placeholder="Select an option"
                                        >
                                            <Option id={1} value="liveBreeder">Live breeder</Option>
                                            <Option id={2} value="eggLayer">Egg layer</Option>
                                        </Select>,
                                    )}
                                </Form.Item>
                            </Col>
                            ...
                            <Col offset={1} span={5} style={{display: "block", marginRight: 20}}>
                                <Form.Item label="Diet" colon={false}>
                                    {getFieldDecorator('diet', {
                                        ...
                                        >
                                            <Option id={1} value="omnivore">Omnivore</Option>
                                            <Option id={2} value="flakes">Flakes</Option>
                                        </Select>
                                    )}
                                </Form.Item>
                            </Col>
                                ...
                                <Form.Item label="Temperament" colon={false}>
                                    {getFieldDecorator('temperament', {
                                        ...
                                        <Select
                                            ...
                                            placeholder="Select any"
                                        >
                                            <Option id={1} value="friendly">Friendly</Option>
                                            <Option id={2} value="aggressive">Aggressive</Option>
                                            <Option id={3} value="loner">Prefers alone</Option>
                                        </Select>
                                    )}
                                </Form.Item>
                            </Col>
                                ...
                                <Form.Item label="Swim Level" colon={false}>
                                    {getFieldDecorator('swimLevel', {
                                        ...
                                        <Select
                                            ...
                                            placeholder="Select any"
                                        >
                                            <Option id={1} value="upper">Upper Level</Option>
                                            <Option id={2} value="mid">Mid-Level</Option>
                                            <Option id={3} value="lower">Bottom</Option>
                                        </Select>
                                    )}
                                </Form.Item>
                            </Col>
                                ...
                                <Form.Item label="Habitat" colon={false}>
                                    {getFieldDecorator('habitat', {
                                        ...
                                        <Select
                                            ...
                                            placeholder="Select any"
                                        >
                                            <Option id={1} value="placeholder">this will be rendered with map() from
                                                DB</Option>
                                        </Select>
                                    )}
                                </Form.Item>
                            ...
                            <Col span={5} style={{display: "block", marginRight: 20}}>
                                <Form.Item label="Water Hardness" colon={false}>
                                    ...
                                    {getFieldDecorator('minHardness', {
                                        initialValue: 10,
                                        onChange: (value) => handleNumericChange('minHardness', value)
                                    },)(
                                        <InputNumber
                                            style={{marginRight: 8}}
                                            min={1}
                                    ...
                                    {getFieldDecorator('maxHardness', {
                                        initialValue: 100,
                                        onChange: (value) => handleNumericChange('maxHardness', value)
                                    },)(
                                        <InputNumber
                                            min={1}
                                            formatter={value => `${value} dH`}
